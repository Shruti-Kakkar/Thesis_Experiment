"""
ruler_bias_finalize_matched.py
Same as ruler_bias_finalize.py, but reads the attributions CSV built by
(possibly several chunked runs of) ruler_bias_local_screening_matched.py
-- the CORRECTED 'ruler_present' CAV -- prints per-class summary
statistics, and regenerates full heatmaps for the top N MEL outliers.
...
from ruler_bias_common_matched import (
